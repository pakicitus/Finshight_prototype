...
def run_pipeline_demo(query: str, user_id: str = "demo_user", db: Optional[Any] = None) -> None:
    ...
    if not has_live_key:
        if "afford" in query.lower():
            ...
            explainer_client = build_mock_explainer_client(
                "Yes, you can afford the phone for ₹10,000. Your remaining balance will be ₹128,372.00 with ₹6,500.00 in upcoming bills reserved."
            )
            ...
            explainer_client = build_mock_explainer_client(
                "You have spent a total of ₹12,400.00 on Food this month, which is 21.94% higher compared to your last period."
            )
